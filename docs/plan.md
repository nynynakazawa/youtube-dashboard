...
### API �G���[�`��
�S�ẴG���[���X�|���X�͎��� JSON �`���ɑ�����B
```json
{
  "error": {
    "code": 400,
    "message": "�`�����l��URL�܂���ID����͂��Ă��������B"
  }
}
```
�t�����g���� `error.message` ���g�[�X�g�\���A`error.code` �Œǉ��n���h�����O���s���B

### �\�[�g�L�[�ꗗ
- `/channels`: `title`, `subscriberCount`, `viewCount`, `videoCount`
- `/channels/{id}/videos`: `publishedAt`, `viewCount`, `likeCount`, `commentCount`

`sort=column:asc|desc` �`���Ŏw�肵�A���w�莞�� `publishedAt:desc` ���f�t�H���g�Ƃ���B
